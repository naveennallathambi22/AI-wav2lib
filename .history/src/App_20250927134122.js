...
function App() {
  ...
  useEffect(() => {
    ...
    const performGreeting = async () => {
      ...
      if (media) {
        ...
        audio.onended = () => {
          ...
          setGreetingCompleted(true); // Only set as completed after greeting is done
          // After lipsync video completes, reset to idle video
    ...
    performGreeting();
  }, [shouldGreet, isFromChatReset, isFromLanguageChange, currentLanguage, addBotMessageFunc]);
