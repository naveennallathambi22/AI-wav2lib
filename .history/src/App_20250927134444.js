...
const addBotMessageFuncRef = useRef(null);
  ...
  const performGreeting = async () => {
    ...
    if (media) {
      ...
      if (addBotMessageFuncRef.current) {
        addBotMessageFuncRef.current(greetingText);
      }
      ...
      audio.onended = () => {
        ...
        setCurrentVideo('/avatar_idle.mp4');
      };
    }
  };

  performGreeting();
}, [shouldGreet, isFromChatReset, isFromLanguageChange, currentLanguage]);
  ...
  addBotMessageFuncRef.current = addBotMessageFunction;
  };
        ...
        <>
          <div className="frame">
            <div className="pane pane-left">
              {/* Looping background video in the black area */}
              <video
              ...
              />
              <div className="avatar-stage" style={{ position: 'relative', zIndex: 1 }}>
